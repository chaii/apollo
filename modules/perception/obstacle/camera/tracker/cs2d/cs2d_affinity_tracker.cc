...
bool CS2DAffinityTracker::get_affinity_matrix(
...
bool CS2DAffinityTracker::update_tracked(const cv::Mat &img,
                                         const std::vector<Detected> &detected,
